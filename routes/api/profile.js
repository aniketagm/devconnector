...
// @desc Go to current user's profile
// @access Private
router.get(
    '/',
...
// @desc Go to user's profile by handle
// @access Public
...
// @desc Go to user's profile by user id
// @access Public
...
// @desc Add or edit experience to user profile
// @access Private
router.post(
    '/experience',
    passport.authenticate('jwt', { session: false }),
...
// @desc Add or edit education to user profile
// @access Private
router.post(
    '/education',
    passport.authenticate('jwt', { session: false }),
...
// @BUGS
// Education and experience gets deleted regardless of incorrect id
